...
\mbox{\Hypertarget{classmpu6050_a4beff110fd439cee20fe7bbf1d18b5cf}\label{classmpu6050_a4beff110fd439cee20fe7bbf1d18b5cf}} 
\index{mpu6050@{mpu6050}!accel\+\_\+config@{accel\+\_\+config}}
\index{accel\+\_\+config@{accel\+\_\+config}!mpu6050@{mpu6050}}
...
this function will change the range of the acceleromter. the default value is 0 value has to be within 0-\/3. it will make the measurment more or less accurate \mbox{\Hypertarget{classmpu6050_af945ffe99c421c67cd4e4134a37f99d2}\label{classmpu6050_af945ffe99c421c67cd4e4134a37f99d2}} 
...
this function will put the \hyperlink{classmpu6050}{mpu6050} out of sleep mode sleep mode has to be disabled to get reliable data from the accelerometer/gyroscope \mbox{\Hypertarget{classmpu6050_a766d1a6a4d9af1dc47a21ae91b1ee289}\label{classmpu6050_a766d1a6a4d9af1dc47a21ae91b1ee289}} 
...
this function puts the chip back in sleep mode. it can be useful if you aren\textquotesingle{}t planning on using the chip anytime soon if disabled, the gyroscope and accelerometer returns 0, and the temperature sensor returns 36 but is unreliable \mbox{\Hypertarget{classmpu6050_ad4a85ae4b16557eed6d4d690840f8358}\label{classmpu6050_ad4a85ae4b16557eed6d4d690840f8358}} 
\index{mpu6050@{mpu6050}!freeze@{freeze}}
\index{freeze@{freeze}!mpu6050@{mpu6050}}
...
this will put the chip in sleep mode but it won\textquotesingle{}t reset it\textquotesingle{}s registers, which means they will keep the last measurement until sleep mode is disabled again \mbox{\Hypertarget{classmpu6050_aec7d7275fdb79b4c2e76dea2cdb99763}\label{classmpu6050_aec7d7275fdb79b4c2e76dea2cdb99763}} 
\index{mpu6050@{mpu6050}!get\+\_\+gyro\+\_\+x@{get\+\_\+gyro\+\_\+x}}
\index{get\+\_\+gyro\+\_\+x@{get\+\_\+gyro\+\_\+x}!mpu6050@{mpu6050}}
...
this function will return the raw value from the x-\/axis of the gyroscope \mbox{\Hypertarget{classmpu6050_ad02ed5082341b88fe8f0231bcfe41b99}\label{classmpu6050_ad02ed5082341b88fe8f0231bcfe41b99}} 
\index{mpu6050@{mpu6050}!get\+\_\+gyro\+\_\+y@{get\+\_\+gyro\+\_\+y}}
\index{get\+\_\+gyro\+\_\+y@{get\+\_\+gyro\+\_\+y}!mpu6050@{mpu6050}}
...
this function will return the raw value from the y-\/axis of the gyroscope \mbox{\Hypertarget{classmpu6050_aa81a142fcb1ba3a3275bf9e2852434d6}\label{classmpu6050_aa81a142fcb1ba3a3275bf9e2852434d6}} 
\index{mpu6050@{mpu6050}!get\+\_\+gyro\+\_\+z@{get\+\_\+gyro\+\_\+z}}
\index{get\+\_\+gyro\+\_\+z@{get\+\_\+gyro\+\_\+z}!mpu6050@{mpu6050}}
...
this function will return the raw value from the z-\/axis of the gyroscope \mbox{\Hypertarget{classmpu6050_abd1ae3f3cdb9dc19c7ae899c733c9714}\label{classmpu6050_abd1ae3f3cdb9dc19c7ae899c733c9714}} 
...
get the angle of the x-\/axis of the current position of a \hyperlink{classmpu6050}{mpu6050} in degrees it can vary between -\/90 and 90 degrees it will be 0 degrees when it is laying, and 90 degrees when it is standing \mbox{\Hypertarget{classmpu6050_ac11bddbc6795e1c36b1f89b743ce63ec}\label{classmpu6050_ac11bddbc6795e1c36b1f89b743ce63ec}} 
...
get the angle of the y-\/axis of the current position of a \hyperlink{classmpu6050}{mpu6050} in degrees it can vary between -\/90 and 90 degrees it will be 0 degrees when it is laying, and 90 degrees when it is standing \mbox{\Hypertarget{classmpu6050_aaac23fed6c6abfc50a5e41c5fdcd22e8}\label{classmpu6050_aaac23fed6c6abfc50a5e41c5fdcd22e8}} 
